 ...
 * @author Lauréna
 */
public class Rectangle implements Dessinable, Perimetrable, Surfacable, Convex {
    Point p1;
    Point p2;
    Point p3;
    Point p4;
    ...
    public void dessineSur(Ardoise a) {
        ...
        /*
        int largeur = (int) p1.distance(p2);
        int hauteur = (int) p2.distance(p3);
        a.remplirQuadrilatere(largeur/2, hauteur/2, largeur, hauteur);
*/
